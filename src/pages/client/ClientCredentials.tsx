...
const ClientCredentials = () => {
  ...
  const handleSaveChanges = () => {
    toast({
      ...
      description: `Your ${selectedService} credentials have been saved successfully.`,
      variant: "default",
    });
  };
    ...
    <div className="flex h-screen bg-background text-foreground">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6 overflow-auto">
          <h1 className="text-2xl font-semibold mb-6">Acme Corporation</h1>
                ...
                {services.map(service => (
                  <div 
                    ...
                    className={`flex items-center p-3 rounded-md cursor-pointer ${
                      selectedService === service.id ? 'bg-muted' : 'hover:bg-muted/50'
                    }`}
                  >
              ...
              <div className="md:col-span-2 bg-card rounded-lg border border-border shadow-sm p-6">
                <div className="flex items-center mb-6">
                  ...
                  {services.find(s => s.id === selectedService)?.isConnected && (
                    <div className="ml-auto flex items-center text-sm text-green-600 dark:text-green-400">
